...
#define RSENSE_03K			(uint32_t)0x1E
//**********************************************************************************************************
// -- Direct ADC --
//**********************************************************************************************************
...
#define MULTI_READ_CH_REGISTER		     (uint16_t) 0x00F4
#define RTD_CH12_CFG_REGISTER		     (uint16_t) 0x022C
#define RSENCE_CH11_CFG_REGISTER		 (uint16_t) 0x0224
#define GLOBAL_CONFIG_REGISTER			 (uint16_t) 0x00F0
//**********************************************************************************************************
// -- MISC CONSTANTS --
//**********************************************************************************************************
...
#define LTC_CMD_SLEEP			(uint8_t) 0x97

#define RTD_CHANNEL				11
#define RSENSE_CHANNEL			9
...
LTC_temperature chData[20];
LTC_chConfig	chConfig[20];
...
uint32_t LTC_TC_readChannelConfig(uint32_t ch);
