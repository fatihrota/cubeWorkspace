...
Core/Startup/startup_stm32l073rztx.o: ../Core/Startup/startup_stm32l073rztx.s
	arm-none-eabi-gcc -mcpu=cortex-m0plus -DRTDEBUG -c -x assembler-with-cpp -MMD -MP -MF"Core/Startup/startup_stm32l073rztx.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@" "$<"
